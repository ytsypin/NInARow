...
public class CurrentStatusServlet extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean playerLeft = gameManager.getIfPlayerLeft(gameNum);

        CurrentStatusInfo info = new CurrentStatusInfo(isActive, currentPlayerName, myTurn, isWinnerFound, winnerNames, noPossibleMoves, singlePlayerLeft, gameEnded, inGame, playerLeft);
    ...
    class CurrentStatusInfo{
        ...
        public CurrentStatusInfo(boolean isActive, String currentPlayerName, boolean myTurn, boolean isWinnerFound, List<String> winnerNames, boolean noPossibleMoves, boolean singlePlayerLeft, boolean gameEnded, boolean inGame, boolean playerLeft){
